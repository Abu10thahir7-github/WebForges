...
const Phrase = ({ src }) => {
  return (
    <div className="flex items-center gap-3 px-3 text-black sm:gap-5 sm:px-5">
      <p className="text-[10vw] leading-none sm:text-[8vw] md:text-[7.5vw]">
        H<span className="text-style-italic">i</span>gh-perf
        <span className="text-style-italic">o</span>rm
        <span className="text-style-italic">i</span>ng
      </p>
