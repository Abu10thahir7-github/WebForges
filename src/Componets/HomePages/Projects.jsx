  ...
  return (
    <div className="project-container sm:w-full md:w-full lg:w-4/5 m-auto flex   justify-end  ">
      <div className="w-[300px]  mx-auto block sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/6 mt-16   flex-col gap-10">
        ...
        <motion.div
          onClick={() => window.open('https://www.flyoceantravel.com/', '_blank')}
          variants={fadeIn('up', 0.2)}
          initial="hidden"
          whileInView={'show'}
          viewport={{ once: true }}
          className="project-card cursor-pointer"
        >
          <img className="" src={flyoean} alt="trendzio_mockup" />
          <div className="project-card-text flex justify-between border-t-[1px] border-t-[#363636] my-5 py-5">
            <div>
              <h2 className="uppercase">Flyocean Travel & Tourism</h2>
              <p className="text-lg text-gray-500 font-light">Travel Agency</p>
            </div>
            <svg
              width="28"
              height="28"
        ...
        <motion.div
          onClick={() => window.open('https://www.talktower.in/', '_blank')}
          variants={fadeIn('up', 0.2)}
          initial="hidden"
          whileInView={'show'}
          viewport={{ once: true }}
          className="project-card cursor-pointer"
        >
          <img className="" src={talktowermockup} alt="trendzio_mockup" />
          <div className="project-card-text flex justify-between border-t-[1px] border-t-[#363636] my-5 py-5">
            <div>
              <h2 className="uppercase">Talk Tower</h2>
              <p className="text-lg text-gray-500 font-light">Education </p>
            </div>
            <svg
              width="28"
              height="28"
